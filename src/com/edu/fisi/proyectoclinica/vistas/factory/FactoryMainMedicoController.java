 ...
 */
public class FactoryMainMedicoController extends FactoryVentanas {
    ...
    public Ventana MetodoFabrica() {
        ...
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(MainAdminController.class.getResource("MainMedico.fxml"));
            Parent root = fxmlLoader.load();
            //MainAdminController .instanciar().getEscritorio().getChildren().add(((Ventana) fxmlLoader.getController()));
            MainMedicoController main= (MainMedicoController) fxmlLoader.getController();
            ...
            Logger.getLogger(FactoryMainMedicoController.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
