...
import com.edu.fisi.proyectoclinica.vistas.LoginController;
 ...
 */
public class FactoryLoginController extends FactoryVentanas {
    ...
    public Ventana MetodoFabrica() {
        ...
        try {
            ...
            String titulo = "Clinica Aquiles Matto";
            FXMLLoader fxmlLoader = new FXMLLoader(MainAdminController.class.getResource("Login.fxml"));
            Parent root = fxmlLoader.load();
            //MainAdminController .instanciar().getEscritorio().getChildren().add(((Ventana) fxmlLoader.getController()));
            LoginController main= (LoginController) fxmlLoader.getController();
            ...
            Logger.getLogger(FactoryLoginController.class.getName()).log(Level.SEVERE, null, ex);
        }
     return null;
    }
